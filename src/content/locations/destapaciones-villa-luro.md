...
bodyServices:
  ...
  lead:
    - "En Villa Luro predominan las casas y los PH, con acceso por una cámara de inspección en el patio o por una rejilla; en los PH de pasillo el espacio para trabajar es más reducido. Las obstrucciones más comunes están en el ramal que une el baño y la cocina con la cloaca, y cuando la casa tiene varias décadas se suma la incrustación acumulada de años."
    - "Trabajamos en casas, PH, departamentos, comercios y consorcios del barrio:"
  note:
    - "Contamos además con servicio de video inspección, que sirve para ubicar en qué tramo la cañería tiene una rotura antes de decidir dónde abrir."
bodyCauses:
  heading: "Por qué se tapan las cañerías en Villa Luro"
  lead:
    - "En Villa Luro conviven dos realidades. Sobre las avenidas, y en particular sobre Ramón Falcón y Juan B. Justo, hay una buena cantidad de edificios. Por dentro del barrio predominan las casas y los PH, con cañerías que en muchos casos son las originales de la construcción."
  items:
    ...
    - icon: "mdi:water-alert-outline"
      ...
      dataText: "Una rejilla que drena lento en un día seco ya avisa"
bodyBrokenPipe:
...
bodyQuote:
  ...
  paragraphs:
    - "Si el problema se describe con detalle, es decir qué se tapó, hace cuánto y qué pasa cuando se usa, muchas veces podemos dar un presupuesto directamente."
